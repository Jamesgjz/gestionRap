...
# Interceptar credenciales del formulario HTML premium
...
# --- ESCENARIO A: FORMULARIO DE INICIO DE SESIÓN PREMIUM ---
...
# --- ESCENARIO B: ENTORNO ADMINISTRATIVO COMPLETO (LOGUEADO) ---
    ...
    # REESCRITURA TOTAL CSS DEL SIDEBAR Y SUS BOTONES NATIVOS
    st.markdown("""
        <style>
        ...
        /* ELIMINAR EL EFECTO CÁPSULA BLANCA Y OSCURA DE STREAMLIT */
        ...
        /* Forzar Texto de Botones en Gris Azulado Claro */
        ...
        /* CORRECCIÓN DEL HOVER: Fondo Azul Destacado y Texto Blanco Puro */
    ...
    with st.sidebar:
        ...
        # Opciones de menú con iconos integrados
        ...
        # RESTAURACIÓN DEL BOTÓN DE CERRAR SESIÓN CON COMPORTAMIENTO PREMIUM
