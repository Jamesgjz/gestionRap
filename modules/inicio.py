...
def obtener_datos_dinamicos_dashboard():
    ...
    res = {
        ...
        "casos_cerrados": 245,
        "tabla_pendientes_html": """<tr><td>Validar documentos de estudiantes</td><td><b>48</b></td><td><span class="pill-alta">Alta</span></td><td>23 may. 2025</td></tr>
...
<tr><td>Resultados por registrar</td><td><b>14</b></td><td><span class="pill-media">Media</span></td><td>27 may. 2025</td></tr>""",
        "actividad_reciente_html": """<div class="timeline-item">
...
<div class="timeline-content"><b>Resultado registrado</b><br><span style="color:#64748b; font-size:0.75rem;">Ayer, 04:32 p. m.</span><br>Estudiante: Juan Camilo Pérez</div>
        ...
        "distribucion_html": """<div class="progress-bar-container">
...
<div class="progress-bar-bg"><div class="progress-bar-fill" style="width: 21%; background: #ea580c;"></div></div>
    ...
    try:
        ...
        res["tabla_pendientes_html"] = """<tr><td>Flujos en Seguimiento</td><td><b>""" + str(c_seguimiento) + """</b></td><td><span class="pill-alta">Alta</span></td><td>Activo</td></tr>
<tr><td>Exámenes Programados</td><td><b>""" + str(c_programacion) + """</b></td><td><span class="pill-media">Media</span></td><td>Pendiente</td></tr>
<tr><td>Trazabilidad de Estados</td><td><b>""" + str(c_estado) + """</b></td><td><span class="pill-alta">Alta</span></td><td>En cola</td></tr>
        ...
        try:
            ...
            if filas_est:
                ...
                for est in filas_est:
                    ...
                    html_act += """<div class="timeline-item">
<div class="timeline-marker" style="background:#0052cc;"></div>
<div class="timeline-content"><b>Fila detectada en DB</b><br><span style="color:#64748b; font-size:0.75rem;">Sincronización en tiempo real</span><br>Valor: """ + str(nombre_visible) + """</div>
        ...
        if total_volumen > 0:
            ...
            res["distribucion_html"] = """<div class="progress-bar-container">
...
def render():
    ...
    parte_superior = """<div class="panel-header">
<div>
...
<div class="metric-icon-box" style="background:#f0fdf4; color:#16a34a;"><i class="fa-regular fa-circle-check"></i></div>
    ...
    parte_inferior = """<div class="workspace-grid">
...
<tbody>""" + str(db['tabla_pendientes_html']) + """</tbody>
</table>
</div>
...
<div class="block-card">
<div>
<div class="block-title">Actividad reciente</div>""" + str(db['actividad_reciente_html']) + """</div>
<div class="footer-link">Ver toda la actividad <i class="fa-solid fa-arrow-right"></i></div>
</div>

<div class="block-card">
<div>
<div class="block-title">Volumen Relativo de Datos</div>""" + str(db['distribucion_html']) + """</div>
