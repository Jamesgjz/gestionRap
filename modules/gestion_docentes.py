...
.btn-nuevo-doc-container div.stButton > button {
    background-color: #0047ff !important; color: white !important; font-size: 1.05rem !important; font-weight: 700 !important; padding: 12px 24px !important; border-radius: 8px !important; border: none !important; box-shadow: 0 4px 6px rgba(0,47,255,0.15) !important;
}
.btn-nuevo-doc-container div.stButton > button:hover { background-color: #0036d6 !important; }
...
""", unsafe_allow_html=True)
    ...
    try:
        ...
        if raw_data:
            for row in raw_data:
                ...
                asignaturas = "Construcción de pruebas" # Forzado real
        ...
        st.sidebar.error(f"Mapeo: {e}")

    tot_doc = len(docentes_filtrados) if docentes_filtrados else 3
    tot_act = sum(1 for d in docentes_filtrados if "activo" in str(d[5]).lower()) if docentes_filtrados else 3
    tot_asig = 3  # Forzado real solicitado
    tot_pend = 0
    ...
    if docentes_filtrados:
        for doc in docentes_filtrados:
            ...
            # CORRECCIÓN DE SINTAXIS EXPLICITA AQUÍ:
            avatar_bg = "#e8f0fe"
            avatar_txt = "#1a73e8"
        ...
        html_table_rows = """
        <tr>
            <td><div class="doc-profile-cell"><div class="doc-avatar" style="background:#e8f0fe; color:#1a73e8;">MF</div><div class="doc-info-text"><span class="doc-name">María Fernanda López</span><span class="doc-email">maria.lopez@uniminuto.edu.co</span></div></div></td>
            <td>Administración de Empresas</td><td><b style="color: #6b21a8;">Construcción de pruebas</b></td><td><b>12</b> hrs</td><td><span class="badge-doc badge-activo">Activo</span></td><td>19/05/2025 10:15</td><td class="action-icons">👁️📝⋮</td>
        </tr>
        <tr>
            <td><div class="doc-profile-cell"><div class="doc-avatar" style="background:#e6f4ea; color:#137333;">JJ</div><div class="doc-info-text"><span class="doc-name">James Gabriel Jaramillo</span><span class="doc-email">james.jaramillo@uniminuto.edu.co</span></div></div></td>
            <td>Ingeniería de Sistemas</td><td><b style="color: #6b21a8;">Construcción de pruebas</b></td><td><b>16</b> hrs</td><td><span class="badge-doc badge-activo">Activo</span></td><td>19/05/2025 09:40</td><td class="action-icons">👁️📝⋮</td>
        </tr>
        <tr>
            <td><div class="doc-profile-cell"><div class="doc-avatar" style="background:#fef7e0; color:#b06000;">RM</div><div class="doc-info-text"><span class="doc-name">Ricardo Morales</span><span class="doc-email">ricardo.morales@uniminuto.edu.co</span></div></div></td>
            <td>Contaduría Pública</td><td><b style="color: #6b21a8;">Construcción de pruebas</b></td><td><b>8</b> hrs</td><td><span class="badge-doc badge-activo">Activo</span></td><td>16/05/2025 14:22</td><td class="action-icons">👁️📝⋮</td>
        </tr>
        """
