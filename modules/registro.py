...
def render():
    # --- CARGA CON ALMACENAMIENTO EN CACHÉ PARA EVITAR CONGELAMIENTO DE BOTONES ---
    ...
    def cargar_modulo_por_archivo(nombre_modulo, nombre_archivo):
        ...
        # Si el módulo ya fue registrado en el sistema, lo reutilizamos para preservar los estados de Streamlit
